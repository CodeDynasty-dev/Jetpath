/* PrismJS 1.30.0
https://prismjs.com/download#themes=prism-okaidia&languages=markup+css+clike+javascript+http+typescript */
const _self =
          ...
          insertBefore: function (e, n, t, r) {
            ...
            for (const o in i)
              if (i.hasOwnProperty(o)) {
                if (o == n)
                  for (const s in t) t.hasOwnProperty(s) && (l[s] = t[s]);
