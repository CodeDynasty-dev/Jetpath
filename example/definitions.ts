export const routes = {
 ...
 GET_error: {
    path: "/error",
    method: "get",
    title: "Route that intentionally throws an error (for testing global error handling)",
},
 GET_export_docs$format: {
    path: "/export/docs/:format",
    method: "get",
    title: "Export API documentation in different formats (json, yaml, markdown)",
},
 GET_health: {
    path: "/health",
    method: "get",
 ...
 GET_petBy$id_gallery: {
    ...
    method: "get",
    title: "Get images for a specific pet (returns main image URL in this sample)",
},
 GET_pets: {
    path: "/pets",
    method: "get",
 ...
 POST_upload: {
    path: "/upload",
    method: "post",
    body: {"image":"file","document":"file","title":"string","description":"string","tags":"string"},
    title: "Upload files with metadata (admin only) - expects multipart/form-data",
},
 POST_pets: {
    path: "/pets",
    method: "post",
    body: {"name":"string","species":"string","breed":"string","age":1,"gender":"string","color":"string","description":"string","image":"file","price":1,"available":true,"tags":[],"health":{}},
